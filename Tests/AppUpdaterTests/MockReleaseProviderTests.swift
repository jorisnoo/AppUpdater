...
final class MockReleaseProviderTests: XCTestCase {
    ...
    func testFetchReleasesFromBundled() async throws {
        ...
        let releases = try await provider.fetchReleases(owner: "example", repo: "AppUpdaterExample")
    ...
    func testFetchReleasesFromFileURL() async throws {
        ...
        let releases = try await provider.fetchReleases(owner: "test", repo: "test")
    ...
    func testDownloadSimulatesProgress() async throws {
        ...
        let stream = try await provider.download(asset: asset, to: saveLocation)
